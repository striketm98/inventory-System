              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Inventory Systems!</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="btn btn-primary btn-user btn-block" type="submit" name="btnlogin">Sign in</button>
                    <hr>
                  <!-- <div class="text-center">
